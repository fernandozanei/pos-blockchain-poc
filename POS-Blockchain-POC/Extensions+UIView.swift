...
extension UIView {
    ...
    func constraintHeight(equalTo constraint: NSLayoutDimension, multiplier: CGFloat = .zero) {
        translatesAutoresizingMaskIntoConstraints = false
        heightAnchor.constraint(equalTo: constraint, multiplier: multiplier).isActive = true
    }
    
    func constraintWidth(equalTo constraint: NSLayoutDimension, multiplier: CGFloat = .zero) {
        translatesAutoresizingMaskIntoConstraints = false
        widthAnchor.constraint(equalTo: constraint, multiplier: multiplier).isActive = true
    }
        
    func aspectRatio(width: CGFloat, height: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
